...
public class TopologyT2 {
	...
	public static void main(String[] args) throws Exception {
        ...
        builder.setBolt("filterId", new MyTortoiseBolt(), nbExecutors).shuffleGrouping("masterStream");
        /*Affectation à la topologie du bolt qui émet le flux de sortie, il prendra en input le bolt nofilter*/
        builder.setBolt("exit", new Exit2Bolt(portOUTPUT), nbExecutors).shuffleGrouping("filterId");
